  ...
  describe('Schedule Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      ...
      it('Should call FitnessClass query and add missing value', () => {
        const schedule: ISchedule = { id: 456 };
        const schFit: IFitnessClass = { id: 73348 };
        schedule.schFit = schFit;
        ...
        const additionalFitnessClasses = [schFit];
      ...
      it('Should update editForm', () => {
        ...
        schedule.schLoc = schLoc;
        const schFit: IFitnessClass = { id: 22611 };
        schedule.schFit = schFit;
        ...
        expect(comp.fitnessClassesSharedCollection).toContain(schFit);
      });
    });
