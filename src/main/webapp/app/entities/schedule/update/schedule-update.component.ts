...
export class ScheduleUpdateComponent implements OnInit {
    ...
    this.fitnessClassService
      ...
      .pipe(
        map((fitnessClasses: IFitnessClass[]) =>
          this.fitnessClassService.addFitnessClassToCollectionIfMissing(fitnessClasses, this.editForm.get('schFit')!.value)
        )
      )
  ...
  protected createFromForm(): ISchedule {
    return {
      ...
      schFit: this.editForm.get(['schFit'])!.value,
    };
  }
}
